...
- **脚本生成坐标**（必须）：用 .cjs 脚本通过三角函数计算鱼骨坐标，脚本输出 JSON 文件后调用 `DEBUG=1 node ./packages/whiteboard-cli/bin/cli.js` 渲染
...
nodes.push({
  type: "ellipse", id: "head", x: headX, y: headY, width: headWidth, height: headHeight,
  fillColor: "#FEE2E2", borderColor: "#EF4444", borderWidth: 2,
  text: [{ content: "核心问题", bold: true, fontSize: 16 }], textColor: "#DC2626",
...
```json
{
  ...
  "nodes": [
    ...
    { "type": "frame", "id": "head", "x": "__headX__", "y": "__headY__",
      "width": 180, "height": 80, "layout": "horizontal",
      "padding": [8, 24], "alignItems": "center", "justifyContent": "center",
      "fillColor": "#FEE2E2", "borderColor": "#EF4444", "borderWidth": 2, "borderRadius": 999,
      "children": [
        { "type": "text", "width": "fit-content", "height": "fit-content",
          "text": [{ "content": "[中心问题]", "bold": true, "fontSize": 16 }], "textColor": "#DC2626" }
      ]
    },
    ...
    { "type": "frame", "id": "c0", "x": "__catX__", "y": "__catY__",
      "width": 120, "height": "fit-content", "layout": "horizontal", "gap": 6, "padding": [6, 10], "alignItems": "center",
      "children": [
        { "type": "icon", "name": "[图标]", "width": 20, "height": 20 },
        { "type": "text", "width": "fill-container", "height": "fit-content", "text": [{"content": "[分类A]", "bold": true, "fontSize": 13}] }
      ]},
    { "type": "connector", "connector": {
    ...
    { "type": "frame", "id": "c0-r0", "x": "__reasonX__", "y": "__reasonY__",
      "width": 140, "height": "fit-content", "layout": "horizontal", "gap": 6, "padding": [4, 8], "alignItems": "center",
      "children": [
        { "type": "text", "width": "fill-container", "height": "fit-content", "text": "[原因1]", "fontSize": 12 }
      ]},
    { "type": "connector", "connector": {
