...
- **形状多样化**：合理搭配不同形状来表达语义 —— **胶囊 frame**（`borderRadius: 999`）用于外部实体/起终点、`diamond` 用于判断路由、`rect` 用于业务处理节点、`cylinder` 用于持久化存储。不要用 `ellipse` 做内容节点，空间利用率低且难对齐。
...
以下是一个混合架构拓扑的完整示例。它同时展示了**透明子图**（Kubernetes Zone，连线可穿透）和**不透明复合节点**（DB 集群、AI 引擎，连线只能连外壳）的标准写法，以及多种形状（胶囊 frame / diamond / rect / cylinder）和语义化配色规范。
  ...
  "nodes": [
    {
      ...
      "children": [
        {
          "type": "frame", "id": "user", "layout": "horizontal",
          "padding": [8, 24], "alignItems": "center", "justifyContent": "center",
          "fillColor": "#E2E8F0", "borderColor": "#64748B", "borderWidth": 1, "borderRadius": 999,
          "children": [
            { "type": "text", "width": "fit-content", "height": "fit-content",
              "text": [{ "content": "Global Users", "bold": true, "fontSize": 14 }], "textColor": "#334155" }
          ]
        },
        {
          ...
          "children": [
            ...
            {
              "type": "frame", "id": "web_pod", "width": 160, "height": "fit-content",
              "layout": "horizontal", "gap": 8, "padding": [8, 12], "alignItems": "center",
              "fillColor": "#FFFFFF", "borderColor": "#2563EB", "borderWidth": 1, "borderRadius": 8,
              "children": [
                { "type": "icon", "name": "server", "width": 24, "height": 24, "color": "#2563EB" },
                { "type": "frame", "layout": "vertical", "gap": 2, "padding": 0, "width": "fill-container", "height": "fit-content", "children": [
                  { "type": "text", "width": "fill-container", "height": "fit-content", "text": [{"content": "Web Pod", "bold": true, "fontSize": 13}] },
                  { "type": "text", "width": "fill-container", "height": "fit-content", "text": "Next.js SSR", "fontSize": 10, "textColor": "#646A73" }
                ]}
              ]
            },
            {
              "type": "frame", "id": "api_pod", "width": 160, "height": "fit-content",
              "layout": "horizontal", "gap": 8, "padding": [8, 12], "alignItems": "center",
              "fillColor": "#FFFFFF", "borderColor": "#2563EB", "borderWidth": 1, "borderRadius": 8,
              "children": [
                { "type": "icon", "name": "api", "width": 24, "height": 24, "color": "#2563EB" },
                { "type": "frame", "layout": "vertical", "gap": 2, "padding": 0, "width": "fill-container", "height": "fit-content", "children": [
                  { "type": "text", "width": "fill-container", "height": "fit-content", "text": [{"content": "API Pod", "bold": true, "fontSize": 13}] },
                  { "type": "text", "width": "fill-container", "height": "fit-content", "text": "Go Lang", "fontSize": 10, "textColor": "#646A73" }
                ]}
              ]
            }
          ]
...
- 本范本中用到了**胶囊 frame**（外部实体，`borderRadius: 999`）、`diamond`（路由判断）、`rect`（业务节点）、`cylinder`（数据库存储）四种形状。外部实体/起终点不使用 `ellipse`。
